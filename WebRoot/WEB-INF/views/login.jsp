...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath }/static/style/css/login.css?v=20170519065559" />
    <script type="text/javascript" src="${staticPath }/static/login.js?v=20170519" charset="utf-8"></script>
</head>
        ...
        <div style="height: 50px; line-height: 50px; margin-top: 10px;border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
            <P style="margin: 0px 35px 20px 45px;">
                ...
                <span style="float: right;">
                    <a style="background: #444; padding: 7px 10px; border-radius: 4px; border: 1px solid #444; border-image: none; color: rgb(255, 255, 255); font-weight: bold;" href="javascript:;" onclick="submitForm()">登录</a>
                </span>
            </P>
        </div>
    </form>
